...
pub fn trigger_user_input(world: &mut World) {
    let keys_pressed = world
        .resource::<ButtonInput<KeyCode>>()
        .get_just_pressed()
        .copied()
        .collect::<Vec<_>>();
    let keys_released = world
        .resource::<ButtonInput<KeyCode>>()
        .get_just_released()
        .copied()
        .collect::<Vec<_>>();
    ...
    if keys_pressed.is_empty()
        && keys_released.is_empty()
        && mouse_pressed.is_empty()
        && mouse_released.is_empty()
    {
        return;
    }
